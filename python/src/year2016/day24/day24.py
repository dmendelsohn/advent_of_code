...
def answer(grid, waypoints, part):
    ...
    del waypoints[
        0
    ]  # We don't really need waypoints, other than to keep track of which waypoints we have
    for p in itertools.permutations(
        waypoints.keys()
    ):  # Not including 0 since we MUST start with it
